#' Change Point Detection using segneigh algorithm
...
#' @param Q Le paramètre Q pour le nombre maximal de rupture.
...
#' segneigh(data, type_changement,Q, penalty, pen.value)
segneigh <- function(data, type_changement = "mean", Q = 100, penalty = "Manual", pen.value = var(data) * log(length(data))) {
